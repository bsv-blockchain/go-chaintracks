module github.com/bsv-blockchain/go-chaintracks
...
replace go.opentelemetry.io/otel/sdk => go.opentelemetry.io/otel/sdk v1.40.0 // CVE-2026-24051: Path Hijacking fix
...
require (
	...
	github.com/bitcoin-sv/go-sdk v1.1.21 // indirect; pinned: teranode and go-teranode-p2p-client still import old path; waiting for upstream to migrate to github.com/bsv-blockchain/go-sdk
	...
	github.com/quic-go/quic-go v0.58.0 // indirect; pinned: v0.59.0+ incompatible with go-libp2p v0.46.0
